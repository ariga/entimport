...
(
    ...
    optional_float32 real
		...
		`,
			...
			expectedFields: map[string]string{
				"field_type": `func (FieldType) Fields() []ent.Field {
	return []ent.Field{field.Int("id"), field.Float64("optional_float").Optional(), field.Float64("optional_float32").Optional()}
}`,
			},
			expectedEdges: map[string]string{
				"field_type": `func (FieldType) Edges() []ent.Edge {
...
(
    ...
    string_default  varchar default 'READ':: character varying not null
		...
		`,
			...
			expectedFields: map[string]string{
				"field_type": `func (FieldType) Fields() []ent.Field {
	return []ent.Field{field.Int("id"), field.Time("datetime").Optional(), field.Float64("decimal").Optional(), field.String("string"), field.String("optional_string").Optional(), field.Bool("bool").Optional(), field.Time("ts").Optional(), field.String("string_default")}
}`,
			},
			expectedEdges: map[string]string{
				"field_type": `func (FieldType) Edges() []ent.Edge {
...
`,
	...
	return []ent.Field{field.Int("id"), field.Int("optional_int").Optional(), field.String("name"), field.String("nickname").Optional().Unique(), field.String("role")}
				...
				"card": `func (Card) Fields() []ent.Field {
	return []ent.Field{field.Int("id"), field.Time("create_time"), field.Float64("balance"), field.String("name").Optional(), field.Int("user_card").Optional().Unique()}
}`,
			},
			expectedEdges: map[string]string{
				"user": `func (User) Edges() []ent.Edge {
